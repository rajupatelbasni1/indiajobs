...
function PDFViewerInner() {
  ...
  if (!file) {
    return <p className="p-10 text-center">No PDF file provided.</p>;
  }
    ...
    <div className="min-h-screen bg-gray-100 p-4">
      <div className="max-w-5xl mx-auto bg-white shadow rounded-lg overflow-hidden">
        ...
        <div className="flex justify-between items-center p-4 border-b">
          <h1 className="font-semibold">PDF Preview</h1>
...
export default function PDFViewerPage() {
  return (
    <Suspense fallback={<p className="p-10 text-center">Loading PDF...</p>}>
      <PDFViewerInner />
    </Suspense>
  );
}